...
from EvaMariaRobot import (BOT_USERNAME, MESSAGE_DUMP_CHAT, SUDOERS, USERBOT_ID,
                 USERBOT_NAME, USERBOT_USERNAME, app, app2, arq)
from EvaMariaRobot.core.keyboard import ikb
from EvaMariaRobot.core.tasks import _get_tasks_text, all_tasks, rm_task
from EvaMariaRobot.core.types import InlineQueryResultCachedDocument
from EvaMariaRobot.modules.info import get_chat_info, get_user_info
from EvaMariaRobot .modules.music import download_youtube_audio
from EvaMariaRobot.utils.functions import test_speedtest
from EvaMariaRobot.utils.pastebin import paste
