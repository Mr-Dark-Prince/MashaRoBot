...
from EvaMariaTgBot.__main__ import STATS, TOKEN, USER_INFO
from EvaMariaTgBot.modules.sql import SESSION
import EvaMariaTgBot.modules.sql.userinfo_sql as sql
from EvaMariaTgBot.modules.disable import DisableAbleCommandHandler
from EvaMariaTgBot.modules.sql.global_bans_sql import is_user_gbanned
from EvaMariaTgBot.modules.sql.afk_sql import is_afk, set_afk
from EvaMariaTgBot.modules.sql.users_sql import get_user_num_chats
from EvaMariaTgBot.modules.helper_funcs.chat_status import sudo_plus
from EvaMariaTgBot.modules.helper_funcs.extraction import extract_user
from EvaMariaTgBot import telethn
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Eva Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
