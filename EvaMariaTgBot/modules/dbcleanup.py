...
import EvaMariaTgBot.modules.sql.global_bans_sql as gban_sql
import EvaMariaTgBot.modules.sql.users_sql as user_sql
from EvaMariaTgBot import DEV_USERS, OWNER_ID, dispatcher
